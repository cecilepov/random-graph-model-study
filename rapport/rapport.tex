...
\begin{figure}[h]%[h!]
\centering
\includegraphics[width=0.\columnwidth]{img/consensus_set.pdf}
\caption{Output}
...
\begin{figure}[h]%[h!]
\centering
\includegraphics[width=0.5\columnwidth]{img/theoreme1.pdf}
\caption{Output}
\label{fig:theoreme1}
\end{figure}
\FloatBarrier
...
\begin{figure}[h]%[h!]
\centering
\includegraphics[width=0.3\columnwidth]{img/theoreme2.pdf}
\caption{Output}
\label{fig:theoreme2}
\end{figure}
\FloatBarrier
